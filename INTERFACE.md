...
> 本專案與 `RICH3_PATCH` 的版面**逐項相同**，只有文案不同。兩者的這份文件除了標題與
> 步驟數之外應保持一致。
...
┌─ 大富翁2 Patch ─────────────────────────┐
│                                          │  ← 外緣 20px
│  大富翁2 Patch  Rich Patch Series        │  標題列
│ ──────────────────────────────────────── │  框線
│  遊戲目錄                                │  標籤
│  ┌──────────────┐ ┌────┐ ┌──────┐        │
│  │ D:\Games\two │ │瀏覽…│ │ 開始 │        │  三者等高 36px
│  └──────────────┘ └────┘ └──────┘        │
│  選到有 RUN.EXE 的那一層。               │  次要說明
│  ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬       │  進度條
│  ┌────────────────────────────────────┐  │
│  │ INFO   找到主程式：RUN.EXE          │  │  日誌區
│  │ WARN   [跳過] 磁片版 1/2            │  │  （撐滿剩餘空間）
│  └────────────────────────────────────┘  │
│                                          │  ← 外緣 20px
└──────────────────────────────────────────┘
```
